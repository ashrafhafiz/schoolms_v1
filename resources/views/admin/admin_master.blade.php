                    ...
                    <ul class="todo-list mt-20">
                        <li class="py-15 px-5 by-1">
                            ...
                            <label for="basic_checkbox_1"
                                class="mb-0 h-15"></label>
                            <!-- todo text -->
                            <span class="text-line">Nulla vitae purus</span>
                            <!-- Emphasis label -->
                            <small class="badge bg-danger"><i
                        ...
                        <li class="py-15 px-5 by-1">
                            ...
                            <small class="badge bg-warning"><i
                        ...
                        <li class="py-15 px-5 by-1">
                            ...
                            <small class="badge bg-primary"><i
