...
<body class="hold-transition theme-primary bg-gradient-primary">
    ...
    <div class="container h-p100">
        <div class="row align-items-center justify-content-md-center h-p100">
                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-5 col-md-7 col-12">
                        <div class="content-top-agile p-10">
                            ...
                            <p class="text-white-50">Register a new membership
                            </p>
                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="checkbox text-white">
                                            <input type="checkbox" name="terms"
                                                id="basic_checkbox_1">
                                            <label for="basic_checkbox_1">I
                                                agree to the
                                                <a href="#" class="text-warning"><b>Terms</b></a>
                                                and
                                                <a href="#" class="text-warning""><b>Policies</b></a>
                                            </label>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <a class="btn btn-social-icon btn-round btn-outline btn-white" href="#"><i class="fa fa-facebook"></i></a>
                                        ...
                                        <div class="text-center">
                                            <p class="mt-15 mb-0 text-white">
                                                Already have an
                                                account?<a href="{{ route('login') }}" class="text-danger ml-5"> Sign In</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <script
                src="{{ asset('assets/icons/feather-icons/feather.min.js') }}">
            </script>
