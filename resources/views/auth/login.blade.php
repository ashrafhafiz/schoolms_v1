                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-5 col-md-7 col-12">
                        <div class="content-top-agile p-10">
                            ...
                            <p class="text-white-50">Sign in to start your
                                session</p>
                        </div>
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center">
                                        <button type="submit"
                                            class="btn btn-info btn-rounded mt-10">SIGN
                                            IN</button>
                                    </div>
                                    <!-- /.col -->
                                </div>
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-white">Don't have an
                                    account?
                                    <a href="{{ route('register') }}" class="text-danger ml-5">Sign Up</a>
                                </p>
                            </div>
                        </div>
                    </div>
